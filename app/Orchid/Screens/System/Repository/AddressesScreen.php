...
class AddressesScreen extends Screen
{
    ...
    {
        return 'Репозиторий адресов. Обычно, данные в этом репозитории заполняются через соответствующие формы. На данном окне вы не можете изменить данные, только просмотреть.';
    }
